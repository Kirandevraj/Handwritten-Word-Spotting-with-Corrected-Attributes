...
# All possible bigrams (26Perm2 + 26 = 676) 
...
#considering the most frequent (75) bigrams
...
class PHOC():
    ...
    def calculate_frequency(self, word):
      ...
      # Calculates the PHOC histogram at level 1
      # Input: word string
      # Output: list size of 1 * 26 
    ...
    def calculate_frequency_of_bigram(self, word):
      ...
      # Calculates the PHOC histogram of most frequent bigrams at level 1(first 75 out of 676)
      # Input: word string
      # Output: list size of 75
    ...
    def calculate_level_2(self, word):
      ...
      # Calculates the PHOC histogram at level 2
      # Input: word string
      # Output: list size of 2 * 26 
    ...
    def calculate_level_2_bigram(self, word):
      ...
      # Calculates the PHOC histogram of most frequent bigrams at level 2
      # Input: word string
      # Output: list size of 2 * 75
    ...
    def calculate_level_3(self, word):
      ...
      # Calculates the PHOC histogram at level 3
      # Input: word string
      # Output: list size of 3 * 26 
    ...
    def calculate_level_4(self, word):
      ...
      # Calculates the PHOC histogram at level 4
      # Input: word string
      # Output: list size of 4 * 26 
    ...
    def __call__(self, word_in):
      ...
      # Calculates the PHOC (Pyramidal histogram of characters at different levels and at different ngrams)
      # Input: Takes a word
      # Output: PHOC of length 384
